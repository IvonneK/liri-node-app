...
function twitterAPISearch(writeToLog) {
console.log('tweets');
console.log(writeToLog + 'variable');
//   var params = {
//                 q: 'IvonneKomis',
//                 count: 15,
...
function spotifyAPISearch(songName, writeToLog) { 
console.log('spotify');
console.log(writeToLog + 'variable');
...
function omdbAPISearch(writeToLog) {
console.log('function omdb');
...
//           writeToLog = "SAVED to log.txt File";
...
function Instructions(writeToLog){
console.log('write');
...
switch(userInput) {
  case "my-tweets":
  console.log('tweets');
    twitterAPISearch(writeToLogFile);
  break;
  case "spotify-this-song":
  console.log('spotify');
    if (userInput2 != null || undefined) {
      console.log(userInput2);
      spotifyAPISearch(userInput2, writeToLogFile);
    }
    else {instructions(writeToLogFile); };
  break;
  case "movie-this":
  console.log('movie');
    if (userInput2 != null || undefined) {
      console.log(userInput2);
      ombdAPISearch(userInput2, writeToLogFile);
    }
    else {instructions(writeToLogFile); };
  break;
  case "do-what-it-says":
  console.log('do what..');
      readRandom(writeToLogFile);
  break;
}


// THIS logic needs to INCLUDED
  // if (err) {
